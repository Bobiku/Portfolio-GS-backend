...
# Build: docker buildx build --platform=linux/arm64 -t registry.local.savaryguillaume.fr/portfolio-gs-backend:[VERSION-plateforme] -t registry.local.savaryguillaume.fr/portfolio-gs-backend:latest .
